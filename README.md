# android-location
Helpers for location services

### Specs
[![](https://jitpack.io/v/cren90/android-location.svg)](https://jitpack.io/#cren90/android-location) [![API](https://img.shields.io/badge/API-23%2B-orange.svg?style=flat)](https://android-arsenal.com/api?level=23) [![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
...
dependencies {
    // other dependencies here
	        ...
	        implementation 'com.github.cren90:android-location:<version>'
	}
```
